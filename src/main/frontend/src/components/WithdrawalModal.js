...
const WithdrawalModal = () => {
    ...
    return (
        <div>
            <button className="accountInfo-button" onClick={handleOpen}>탈퇴하기</button>
            <Modal
            ...
            >
                ...
                <div className= {isMobileScreen ? classes.paperMobile : classes.paper}>
                    <h3 id="transition-modal-title">회원 탈퇴</h3>
                    <div className="sub-modal-content">
                        <h4>정말 탈퇴하시겠습니까?</h4>                        
                        <div className="button-wrapper">
                            <button type="button" className="submitBtn" onClick={withdrawalHandler}>탈퇴하기</button>
