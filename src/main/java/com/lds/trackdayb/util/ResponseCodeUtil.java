...
public final class ResponseCodeUtil {
    ...
    public static final String RESULT_CODE_INVALID_FILE_TYPE = "9985"; // 부적절한 파일 타입.
    public static final String RESULT_CODE_UNSUPPORT_FILE_PART_NAME = "9986";
    ...
    public final static String RESULT_CODE_ID_PASSWORD_VALID_FAIL = "9996";					// 아이디 또는 패스워드 유효성 실패.
